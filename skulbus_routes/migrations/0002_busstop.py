# Generated by Django 4.0 on 2024-05-01 05:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('longitude', models.DecimalField(decimal_places=6, max_digits=16, verbose_name='Longitude')),
                ('latitude', models.DecimalField(decimal_places=6, max_digits=16, verbose_name='Latitude')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('route', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bus_stop_route', to='skulbus_routes.route', verbose_name='Route')),
            ],
            options={
