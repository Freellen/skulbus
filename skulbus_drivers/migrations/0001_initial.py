# Generated by Django 4.0 on 2024-05-01 05:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driving_licence', models.CharField(max_length=120, verbose_name='Driving licence Number')),
                ('active', models.BooleanField(default=True, verbose_name='Active')),
                ('vehicle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='driver_bus', to='skulbus_buses.bus', verbose_name='Vehicle')),
            ],
            options={
                'verbose_name': 'Driver',
